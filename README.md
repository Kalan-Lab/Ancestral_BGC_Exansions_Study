...
* **10_Recent_Horizontal_Gene_Transfer_Assessment**: Code and select data for assessing signatures of recent horizontal transfer in bacteria, archaea, and fungi.
