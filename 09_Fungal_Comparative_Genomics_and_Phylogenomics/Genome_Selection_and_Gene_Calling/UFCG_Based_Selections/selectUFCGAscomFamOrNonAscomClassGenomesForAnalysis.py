...
genomes_dir = 'Genomes/'  # directory with all UFCG genomes in FASTA format
for f in os.listdir(genomes_dir):
    gca = '_'.join(f.split('_')[:2])
    gca_with_genomes.add(gca)

abyss_file = 'Abyss_Fac_Stats_for_UFCG_Species_Rep_Genomes.txt'
gca_n50s = {}
...
ufcg_dir = 'Species_UFCG/' # Species rep information files downloaded from UFCG webserver
