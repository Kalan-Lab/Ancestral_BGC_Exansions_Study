...
data = {}
print('\t'.join(['order', 'median_genome_size', 'median_bgcome_size', 'median_bgcome_size_relaxed', 'median_npbgcome_size', 'median_nrps_count', 'median_pks_count', 'median_oxy_count', 'median_distinct_cazy_count', 'median_total_cazy_count']))
for o in orders:
    ...
    row = '\t'.join([str(x) for x in [o, mgs, mbs, mrbs, mnps, mns, mps, mkf, mcf, mtcf]])
    data[o] = row
