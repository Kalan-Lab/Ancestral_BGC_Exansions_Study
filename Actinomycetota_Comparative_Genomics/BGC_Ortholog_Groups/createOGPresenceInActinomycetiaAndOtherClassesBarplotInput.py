...
print('og\tgroup\tcat\tcount\ttotal_actino_count')
for og in ogs:
    prods = products[og]
    ...
    total_actino_count = bgc_actino + other_actino
    ...
    print(og + '\t' + group + '\tbgc_actino\t' + str(bgc_actino) + '\t' + str(total_actino_count))
    print(og + '\t' + group + '\tbgc_other\t' + str(0-bgc_other) + '\t' + str(total_actino_count))
    print(og + '\t' + group + '\tother_actino\t' + str(other_actino) + '\t' + str(total_actino_count))
    print(og + '\t' + group + '\tother_other\t' + str(0-other_other) + '\t' + str(total_actino_count))
