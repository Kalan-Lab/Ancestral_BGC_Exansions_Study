...
all_genomes_dir = os.path.abspath('Genomes/') + '/'
ncbi_genbank_dir = os.path.abspath('GFFs_from_NCBI_GenBank/') + '/'
ncbi_refseq_dir = os.path.abspath('GFFs_from_NCBI_RefSeq/') + '/'
ncbi_refseq_fasta_dir = os.path.abspath('Genome_Fastas_in_NCBI_RefSeq/') + '/'
funannotate_dir = os.path.abspath('Funannotate_Results/') + '/'
prob_gcas_file = 'Problematic_NCBI_GCAs_or_GCFs.txt'
